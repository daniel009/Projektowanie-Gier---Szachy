...
public class MyChessmate extends JFrame implements MouseListener{
    ...
    int history_count;
    Color bg_color = Color.decode("#f3ca70");
    
    public MyChessmate(){
        super("Projekt na zaliczenie SZACHY ");                                  
    ...
    public void showEndGameResult(String message){
        int option = JOptionPane.showOptionDialog(null,
                message,"Koniec Gry",0,JOptionPane.PLAIN_MESSAGE,
                null,new Object[]{"Zagraj jeszcze raz","Anuluj"},"Zagraj jeszcze raz");
        if(option == 0){
    ...
    public class ChessBoardPane extends JPanel implements MouseListener{     
        ...
        public void paintComponent(Graphics g){
            ...
            g.drawImage(images.get(GameData.MYCHESSMATE),150,20,this);
    ...
    public class HistoryBoardPane extends JPanel{
        ...
        public void paintComponent(Graphics g){
            super.paintComponent(g);
            g.drawImage(images.get(GameData.HISTORY_TITLE),115,15,this);
    ...
    public void quit(){
        int option = JOptionPane.showConfirmDialog(null,"Czy chcesz zakończyć grę?", 
                    "Szachy", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
